...
var DummyComponent = /** @class */ (function () {
    ...
    DummyComponent.prototype.onCreatePost = function (postData) {
        ...
        this.http.post('http://localhost:5000/user/create', postData).subscribe(function (responseData) {
            console.log(responseData);
        });
    };
    DummyComponent.prototype.onGetUser = function (username) {
        console.log("Get User", username.value);
        this.http.get('http://localhost:5000/user/get', username).subscribe(function (responseData) {
            console.log(responseData);
        });
    };
    DummyComponent.prototype.onGetAll = function () {
        var _this = this;
        console.log("Get All");
        this.http.get('http://localhost:5000/user/getall').subscribe(function (responseData) {
    ...
    DummyComponent.prototype.onUpdate = function (x) {
        ...
        console.log(x.form.value);
        this.http.put('http://localhost:5000/user/update', x.form.value).subscribe(function (responseData) {
            console.log(responseData);
        });
    };
    ...
    DummyComponent.prototype.onDelete = function (x) {
        ...
        this.http["delete"]('http://localhost:5000/user/delete', options).subscribe(function (responseData) {
            console.log(responseData);
        });
    };
