...
const DEFAULT_SAUCE_CONNECT_VERSION = '4.6.2';
...
const protocols = [require('../apis/sauce.json'), require('../apis/rdc.json'), require('../apis/performance.json'), require('../apis/testrunner.json'), require('../apis/datastore.json')];
